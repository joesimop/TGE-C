...
void setup_debug_messenger(VkInstance *instance) {
    ...
    ASSERT(__create_debug_utils_messenger_ext(*instance, &createInfo, NULL, &g_debugMessenger) == VK_SUCCESS , "Failed to set up debug messenger!");
}
...
void destroy_debug_messenger(VkInstance instance) {
    __destroy_debug_utils_messenger_ext(instance, NULL);
}
